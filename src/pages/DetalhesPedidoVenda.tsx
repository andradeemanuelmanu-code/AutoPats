...
const DetalhesPedidoVenda = () => {
  ...
  const { salesOrders, updateSalesOrderStatus } = useAppData();
  ...
  return (
    <>
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-lg font-semibold md:text-2xl text-foreground">Detalhes do Pedido de Venda</h1>
...
export default DetalhesPedidoVenda;